...
cerl -asan -noshell -pa _build/addr_san_test+test/lib/sasl_auth/test -pa _build/addr_san_test+test/lib/sasl_auth/ebin -eval "sasl_auth_tests:test(),erlang:halt()" 
